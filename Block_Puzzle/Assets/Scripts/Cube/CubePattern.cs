    ...
    public void SetPattern(int stageNum)
    {
        switch (stageNum)
        {
            ...
            case 4:
                ...
                break;
            case 5:
                SetFloorColor(cubeBlocks.floors[0].floor, new int[] { 7 }, Color.red);
                SetFloorColor(cubeBlocks.floors[0].floor, new int[] { 6 }, Color.blue);
                SetFloorColor(cubeBlocks.floors[0].floor, new int[] { 8, 9 }, Color.yellow);
                SetFloorColor(cubeBlocks.floors[1].floor, new int[] { 8 }, Color.red);
                SetFloorColor(cubeBlocks.floors[1].floor, new int[] { 9 }, Color.blue);
                SetFloorColor(cubeBlocks.floors[2].floor, new int[] { 9 }, Color.red);
                break;
            default:
                break;
        }
